...
if ($_GET['search'] && $_GET['sort'])
	$command = escapeshellcmd('python3 /home/jsl4/4910/ebaysdk-python-2.1.4/ebay/findbykeywords.py '.$_GET['search'].' '.$_GET['sort']);
elseif ($_GET['search'])
	$command = escapeshellcmd('python3 /home/jsl4/4910/ebaysdk-python-2.1.4/ebay/findbykeywords.py '.$_GET['search']);
else
	$command = escapeshellcmd('python3 /home/jsl4/4910/ebaysdk-python-2.1.4/ebay/findbykeywords.py "bumper sticker"');
