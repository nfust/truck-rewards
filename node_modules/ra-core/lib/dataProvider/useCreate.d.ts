 ...
 * };
 */
declare const useCreate: (resource: string, data?: any, options?: any) => [(query?: Partial<import("./useMutation").Mutation>, options?: Partial<import("./useMutation").MutationOptions>) => void, {
    data?: any;
    total?: number;
    error?: any;
    loading: boolean;
